...
for fname in  flist:
    ...
    pd.DataFrame.to_csv(ftp, '/Users/zsc/ml/data_olympic/train_sid0118/' + uid+'_'+fname+ '.csv', encoding='utf8', index=None)
    pd.DataFrame.to_csv(ftp, '/Users/zsc/ml/data_olympic/test_sid0118/' + uid+'_'+ fname+ '.csv', encoding='utf8', index=None)
