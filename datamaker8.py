...
file = codecs.open("/Users/zsc/Desktop/test.txt",'r','utf8')
...
for line in tweets[0:300]:
    ...
    if '404' in line_httpcode_30m:
        httpcode_30m_404.append(int(line_httpcode_30m['404'])+2)
    else:
...
pd.DataFrame.to_csv(result,'~/ml/data/good_bad_data.txt',encoding='utf8')