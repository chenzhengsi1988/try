...
pd.DataFrame.to_csv(fm_s,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/mean_std003.csv',encoding='utf8',index=None)
pd.DataFrame.to_csv(fm_s,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/mean_std_v_3.csv',encoding='utf8',index=None)
...
pd.DataFrame.to_csv(sframe2,'~/ml/data/baddata2.txt',encoding='utf8')

alldata=[sframe[0:2700],sframe2[0:270]]
alldata5=[frame[0:2700],frame2[0:270]]

result = pd.concat(alldata)

result5 = pd.concat(alldata5)
pd.DataFrame.to_csv(result,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_training003.csv',encoding='utf8',index=None,header=None)

pd.DataFrame.to_csv(result,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_training_v_3.csv',encoding='utf8',index=None,header=None)

pd.DataFrame.to_csv(result5,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_training_dl.csv',encoding='utf8',index=None)


alldata2=[sframe[2000:3000],sframe2[270:300]]
alldata3=[frame[2000:3000],frame2[270:300]]
result2 = pd.concat(alldata2)
result3 = pd.concat(alldata3)
pd.DataFrame.to_csv(result3,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_test003.csv',encoding='utf8',index=None,header=None)
pd.DataFrame.to_csv(result2,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_test000v3.csv',encoding='utf8',index=None,header=None)
pd.DataFrame.to_csv(result3,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_test_v_3.csv',encoding='utf8',index=None)
