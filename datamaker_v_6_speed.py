...
pd.DataFrame.to_csv(sframe,'~/ml/data/gooddata_speed1212.txt',encoding='utf8')
...
pd.DataFrame.to_csv(fm_s,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/mean_stdspeed1212.csv',encoding='utf8',index=None)
pd.DataFrame.to_csv(fm_s,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/mean_std_v_speed1212.csv',encoding='utf8',index=None)
...
pd.DataFrame.to_csv(S_framea2,'~/ml/data/baddata21212.txt',encoding='utf8')
pd.DataFrame.to_csv(sframe2,'~/ml/data/baddata21212333.txt',encoding='utf8')
...
pd.DataFrame.to_csv(result,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_trainingspeed1212.csv',encoding='utf8',index=None,header=None)

pd.DataFrame.to_csv(result,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_training_v_speed1212.csv',encoding='utf8',index=None,header=None)

pd.DataFrame.to_csv(result5,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_training_speed1212.csv',encoding='utf8',index=None)
...
pd.DataFrame.to_csv(result3,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_testspeed1212.csv',encoding='utf8',index=None,header=None)
pd.DataFrame.to_csv(result2,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_test000vspeed1212.csv',encoding='utf8',index=None,header=None)
pd.DataFrame.to_csv(result3,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_test_v_speed1212.csv',encoding='utf8',index=None)
# print(type(body_bytes_sent))
# print(type(request_time))