...
pd.DataFrame.to_csv(fm_s,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/mean_std.csv',encoding='utf8',index=None)
...
pd.DataFrame.to_csv(result,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_training_v_1.csv',encoding='utf8',index=None,header=None)


alldata2=[sframe[2700:3000],sframe2[270:300]]
result2 = pd.concat(alldata2)
pd.DataFrame.to_csv(frame2,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_test_v_1.csv',encoding='utf8',index=None)
