...
for iuid in range(10000001,10000011):
    ...
    pd.DataFrame.to_csv(ftp,'/Users/zsc/ml/data_olympic/train0119/'+ str(iuid)+'_'+fname[0]+'.csv',encoding='utf8', index=None)
    ...
    pd.DataFrame.to_csv(ftp1,'/Users/zsc/ml/data_olympic/test0119/'+ str(iuid)+'_'+fname[0]+'.csv',encoding='utf8', index=None)
    ...
    sortlist = ['timestamp', 'value']
    ftp = ftp.reindex(columns=sortlist)
    pd.DataFrame.to_csv(ftp,'/Users/zsc/ml/data_olympic/train0119/'+ str(iuid)+'_'+fname[1]+'.csv',encoding='utf8', index=None)
    ...
    # print ['~/ml/olympic_data/training/'str(iuid),'.csv']
    # pd.DataFrame.to_csv(ftp,'/Users/zsc/ml/data_olympic/training/'+ str(iuid)+'.csv',encoding='utf8', index=None)
    pd.DataFrame.to_csv(ftp1,'/Users/zsc/ml/data_olympic/test0119/'+ str(iuid)+'_'+fname[1]+'.csv',encoding='utf8', index=None)
    ...
    sortlist = ['timestamp', 'value']
    ftp = ftp.reindex(columns=sortlist)
    pd.DataFrame.to_csv(ftp,'/Users/zsc/ml/data_olympic/train0119/'+ str(iuid)+'_'+fname[2]+'.csv',encoding='utf8', index=None)
    ...
    # print ['~/ml/olympic_data/training/'str(iuid),'.csv']
    # pd.DataFrame.to_csv(ftp,'/Users/zsc/ml/data_olympic/training/'+ str(iuid)+'.csv',encoding='utf8', index=None)
    pd.DataFrame.to_csv(ftp1,'/Users/zsc/ml/data_olympic/test0119/'+ str(iuid)+'_'+fname[2]+'.csv',encoding='utf8', index=None)
