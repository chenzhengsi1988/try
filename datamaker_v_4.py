...
file=open("/Users/zsc/Desktop/data1208.txt", 'r')
for line in file :
...
pd.DataFrame.to_csv(sframe,'~/ml/data/gooddata1208.txt',encoding='utf8')
...
for line in tweets:
    ...
    if '404' in line_httpcode_30m:
        httpcode_30m_404.append(int(line_httpcode_30m['404'])+100000)
    else:
        httpcode_30m_404.append(int(0)+100000)
...
pd.DataFrame.to_csv(fm_s,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/mean_std1208.csv',encoding='utf8',index=None)
pd.DataFrame.to_csv(fm_s,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/mean_std_v_4.csv',encoding='utf8',index=None)
...
pd.DataFrame.to_csv(result,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_training1208.csv',encoding='utf8',index=None,header=None)

pd.DataFrame.to_csv(result,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_training_v_4.csv',encoding='utf8',index=None,header=None)

pd.DataFrame.to_csv(result5,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_training_dl1208.csv',encoding='utf8',index=None)
...
pd.DataFrame.to_csv(result3,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_test1208.csv',encoding='utf8',index=None,header=None)
pd.DataFrame.to_csv(result2,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_test000v4.csv',encoding='utf8',index=None,header=None)
pd.DataFrame.to_csv(result3,'~/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_test_v_4.csv',encoding='utf8',index=None)
