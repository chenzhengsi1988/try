...
for fname in  flist:
    ...
    pd.DataFrame.to_csv(ftp, '/Users/zsc/source/kafka_stream_data_pipe/src/test/resources/training2/' + uid+'_'+fname+ '.csv', encoding='utf8', index=None)
    pd.DataFrame.to_csv(ftp, '/Users/zsc/source/kafka_stream_data_pipe/src/test/resources/testing2/' + uid+'_'+ fname+ '.csv', encoding='utf8', index=None)
