...
pd.DataFrame.to_csv(result,'~/ml/data/security_training.csv',encoding='utf8',index=None,header=None)


alldata2=[sframe[2700:3000],sframe2[270:300]]
result2 = pd.concat(alldata2)
pd.DataFrame.to_csv(result2,'~/ml/data/security_test.csv',encoding='utf8',index=None,header=None)
print(sum11)
print(sum21)
print(sum31)
print(sum41)
