...
for num in range(0,25):
    ...
    F_scaled[:, num] = sklearn.preprocessing.normalize(aaa.reshape(1, -1))
...
for num in range(0,25):
    ...
    # print(bbb)
    F_scaled2[:,num]=sklearn.preprocessing.normalize(aaa.reshape(1,-1))
    # print(F_scaled2[:,num])
...
pd.DataFrame.to_csv(result,'~/ml/data/good_bad_data_training6.txt',encoding='utf8',index_label=sortlist,index=None)


alldata2=[sframe[2700:3000],sframe2[2700:3000]]
result2 = pd.concat(alldata2)
pd.DataFrame.to_csv(result2,'~/ml/data/good_bad_data_testing6.txt',encoding='utf8',index_label=sortlist,index=None)


# print(frameanp2[:,0])
# bbb=0.0
# print(aaa.reshape(1, -1))
# scaler.fit_transform(aaa.reshape(1, -1))
# print(aaa)
# F_scaled2[:,num]=aaa
# print(F_scaled2[:,0])
# print(bbb[0][0])
# print( scaler.fit_transform(aaa))