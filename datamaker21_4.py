...
pd.DataFrame.to_csv(result,'~/ml/data/good_bad_data_training3_4.txt',encoding='utf8',index=None)


alldata2=[sframe[2700:3000],sframe2[2700:3000]]
result2 = pd.concat(alldata2)
pd.DataFrame.to_csv(result2,'~/ml/data/good_bad_data_testing3_4.txt',encoding='utf8',index=None)
