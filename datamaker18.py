...
# pd.DataFrame.to_csv(result ,'~/ml/data/good_bad_data_training33.txt',encoding='utf8',index_label=sortlist,index=None,header=None)
...
# scaler = preprocessing.StandardScaler()
scaler=preprocessing.MinMaxScaler()
F_scaled2 = scaler.fit_transform(frameanp2)
...
pd.DataFrame.to_csv(result,'~/ml/data/good_bad_data_training5.txt',encoding='utf8',index_label=sortlist,index=None,header=None)


alldata2=[sframe[2700:3000],sframe2[2700:3000]]
result2 = pd.concat(alldata2)
pd.DataFrame.to_csv(result2,'~/ml/data/good_bad_data_testing5.txt',encoding='utf8',index_label=sortlist,index=None,header=None)
