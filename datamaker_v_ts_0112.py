...
for fname in  flist:
    ...
    pd.DataFrame.to_csv(ftp, '/Users/zsc/source/egads_allseeing/src/test/resources/training2/' + fname+ '.csv', encoding='utf8', index=None)
    pd.DataFrame.to_csv(ftp, '/Users/zsc/source/egads_allseeing/src/test/resources/testing2/' + fname+ '.csv', encoding='utf8', index=None)
