...
tf.app.flags.DEFINE_string('server', '54.222.162.89:9000',
                           'Server host:port.')
...
def main(_):
    ...
    with open('/Users/zsc/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_testspeed1224.csv', 'rb') as f:
