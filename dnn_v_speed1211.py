...
if __name__ == '__main__':
    ...
    TESTo_URL = '/Users/zsc/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_test_v_speed1211.csv'
    MS_URL='/Users/zsc/ml/DNN/tf_dataset_and_estimator_apis/dataset/mean_std_v_speed1211.csv'
    ...
    pd.DataFrame.to_csv(sff, '~/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_test_f_speed1211.csv', encoding='utf8',header=None,
                        index=None)
    TEST_URL = '/Users/zsc/ml/DNN/tf_dataset_and_estimator_apis/dataset/security_test_f_speed1211.csv'
    # PATH = "tf_dataset_and_estimator_apis"
    #
    ...
    classifier = tf.estimator.DNNClassifier(
        ...
        hidden_units=[200,100,50],  # Two layers, each with 10 neurons
    ...
    train_input_fn = create_train_input_fn(TRAIN_URL, label_name='label', repeat_count=1)
