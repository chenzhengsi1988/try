...
pd.DataFrame.to_csv(result,'~/ml/data/good_bad_data_training3.txt',encoding='utf8',index=None)


alldata2=[frame[2700:3000],frame2[2700:3000]]
result2 = pd.concat(alldata2)
pd.DataFrame.to_csv(result2,'~/ml/data/good_bad_data_testing3.txt',encoding='utf8',index=None)
