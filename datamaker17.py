...
alldata=[frame[0:2700],frame2[0:2700]]
result = pd.concat(alldata)
pd.DataFrame.to_csv(result,'~/ml/data/good_bad_data_training3.txt',encoding='utf8',index_label=sortlist,index=None,header=None)


alldata2=[frame[2700:3000],frame2[2700:3000]]
result2 = pd.concat(alldata2)
pd.DataFrame.to_csv(result2,'~/ml/data/good_bad_data_testing3.txt',encoding='utf8',index_label=sortlist,index=None,header=None)
